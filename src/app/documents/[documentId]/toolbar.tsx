...
import { LucideIcon, Undo2Icon, Redo2Icon, PrinterIcon, BoldIcon, ItalicIcon, UnderlineIcon, ListTodoIcon, RemoveFormattingIcon, MessageSquarePlusIcon, ChevronDownIcon, HighlighterIcon, Link2Icon, ImageIcon, UploadIcon, SearchIcon, AlignLeftIcon, AlignCenterIcon, AlignRightIcon, AlignJustifyIcon, ListIcon, ListOrderedIcon, MinusIcon, PlusIcon } from "lucide-react";
    ...
    <div className="flex items-center gap-x-0.5">
      ...
      {isEditing ? (
        <input
          ...
          className="h-7 w-10 text-sm text-center border border-neutral-400 rounded-sm hover:bg-neutral-200/80 bg-transparent focus:outline-none focus:ring-0"
        />
      ...
      <DropdownMenuContent className="p-1 flex flex-col gap-y-1">
          {fonts.map(({ label, value }) => (
            <button
              ...
              key={value}
              // implement that once clicks the dropdown menu collapses
              className={cn(
                  "flex items-center gap-x-2 px-2 py-1 rounded-sm hover:bg-neutral-200/80",
